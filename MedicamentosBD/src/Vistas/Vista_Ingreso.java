...
public class Vista_Ingreso extends Vista{
    ConexionBD Conexion_Actual; 
    Modelo_Ingreso Controlador_Ingr; 
    Modelo_Paciente Controlador_Pac; 
    public Vista_Ingreso(ConexionBD Conexion_Actual,Modelo_Ingreso Ingreso,Modelo_Paciente Controlador_Pac){
        this.Conexion_Actual=Conexion_Actual; 
        this.Controlador_Pac=Controlador_Pac; 
        this.Controlador_Ingr=Ingreso; 
        // Inicializar Objetos
        ...
        Controlador_Ingr.InitializeInstance("I-1217",5, "Salpullido y comezon en la piel ", "Varicela", "10-10-2024 10:00:10", "16-10-2024 9:11:00");
    ...
    @Override
    public Modelo_Ingreso getControlador(){
        return this.Controlador_Ingr;
    }
    
    public void inicializarRelaciones(){
        // Relacion Ing-Pac
        Controlador_Ingr.RelationshipIngreso_Paciente("I-1281", "Ricardo Moreno");
        Controlador_Ingr.RelationshipIngreso_Paciente("I-0128", "Maria Gonzalez");
        Controlador_Ingr.RelationshipIngreso_Paciente("I-1297", "Jesus Ochoa");
        Controlador_Ingr.RelationshipIngreso_Paciente("I-9483", "Ricardo Moreno");
        Controlador_Ingr.RelationshipIngreso_Paciente("I-1217", "Maria Gonzalez");
        Controlador_Ingr.RelationshipIngreso_Paciente("I-9373", "Jesus Ochoa");
        Controlador_Ingr.InsertAllToBD();
    }
}
