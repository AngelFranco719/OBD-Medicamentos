...
public class Vista_Prescripcion extends Vista{
    ...
    public Vista_Prescripcion(ConexionBD Conexion_Actual,Modelo_Prescripcion Prescripcion,Modelo_Paciente Controlador_Pac, Modelo_Personal Controlador_Per,Modelo_Lista Controlador_Lis){
        this.Conexion_Actual=Conexion_Actual; 
        this.Controlador_Pac=Controlador_Pac;
        this.Controlador_Per=Controlador_Per;
        this.Controlador_Lis=Controlador_Lis; 
        this.Controlador_Pres=Prescripcion;
        /// Inicializar Objetos
    ...
    @Override
    public Modelo_Prescripcion getControlador(){
        return this.Controlador_Pres;
    }
