...
public class JFConfirmaPersonal extends javax.swing.JFrame {
    ...
    /**
     * Creates new form JFConfirmaPersona
     */
    public JFConfirmaPersonal() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        ComboRoles.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ComboRoles.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ENFERMERO", "MEDICO" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFConfirmaPersonal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFConfirmaPersonal().setVisible(true);
            }
        });
    }
